    ...
    return (
        ...
        <>
            ...
            <div className='bg-black flex justify-center items-center text-white  w-full bg-cover bg-no-repeat h-56' style={{ backgroundImage: `url("/asset/bg-lines-svg.svg")` }} >
                ...
                <div>
                    <h1 className='text-2xl lg:text-6xl font-[400] mb-4 text-[#C5B351] '>Buyer’s Guide</h1>
            ...
            <div className="container mx-auto py-6 lg:py-20 px-4 lg:px-10">
                ...
                <div className="max-w-4xl mx-auto">
                    <div className="mb-8">
                         ...
                         <p className='text-xl  font-normal mb-8'>Choosing to buy a home is one of the biggest decisions you’ll make in your life. It’s a complex ordeal that requires a lot of planning, and instating the help of a knowledgeable REALTOR® to make the process run smoothly. To ready you for this, 
                            here is a general overview of what to expect and prepare.</p>
                        <h2 className="text-xl lg:text-2xl font-normal mb-4 text-[#C5B351]">Get Your Finances In Order</h2>

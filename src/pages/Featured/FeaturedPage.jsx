...

          {
            Searchtogglemenu && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mt-8">
                ...
                <div class="max-w-sm">
                  <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm  focus:ring-blue-500 focus:border-blue-500 block w-full p-3 ">
                  ...
                  {/* <table className="w-full text-sm text-left rtl:text-right">
                    ...
                    <tbody>
                      <tr className="bg-white border">
                        <td className="px-4 border py-1.5">
                          {property["Status:"]}
                        </td>
                        <td className="px-4 border py-1.5">
                          {property["MLS® Num:"]}
